...
# from models.FDTD_Exp_init import FDTD2D
from models.FDTD_Exp import FDTD2D
# from models.FDTDoss_revised_k import FDTD2D
# from models.Modified_FDTD import FDTD2D
# from models.TemporalFDTD import FDTD2D
# from models.FDTD_IM import GeneralizedFDTD2D as FDTD2D

# from models.BioLinOSS import BioLinOSS as FDTD2D
...
def create_model(
    ...
    *,
    ...
    if model_name == 'FDTD':
        ...
        # Extract FDTD-specific parameters from model_args
        # Use fdtd_args here to initialize your FDTD model
        fdtd_wave_speed = 1.0
        fdtd_damping_p = 0.1
        fdtd_damping_v = 0.1
        # Import FDTD class here to avoid circular imports

        # Initialize and return the FDTD model
        fdtd = FDTD2D(
            num_blocks,
            data_dim,
            ssm_dim,  # using ssm_dim as grid_size
            hidden_dim,
            label_dim,
            classification,
            output_step,
